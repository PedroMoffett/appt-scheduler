...
/**
 * Abstract class that logs login attempt information to a text file
 */
public abstract class LoginTracker {
    ...
    /**
     * Method that logs login attempt information to a text file with formatted dateTime, noting success or failure.
    ...
    public static void trackLogin(String username, boolean access) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(text_file, true))){
            ...
            System.err.println("Failed to retrieve login information");
            e.printStackTrace();
        }
    }
}
