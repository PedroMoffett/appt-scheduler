...
/**
 * Controller class for the create-customer-view that allows user to add customer to database.
 */
public class CreateCustomerController implements Initializable {

    /**
     * Initialize method sets values and listeners for comboBoxes. - CONTAINS LAMBDA
     * <p>
    ...
    /**
     * MouseEvent for cancel button which returns user to directory without
     * submitting info
    ...
    /**
     * MouseEvent for create customer button which validates user input
     * then uses it to call the createCustomer query method.
