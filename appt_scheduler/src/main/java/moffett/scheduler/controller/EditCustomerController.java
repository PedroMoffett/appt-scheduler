...
/**
 * Controller for the edit-customer-view that allows user to edit selected customer information.
 */
public class EditCustomerController implements Initializable {
    ...
    /**
     * MouseEvent for cancel button that returns user to directory without
     * submitting any info.
    ...
    /**
     * MouseEvent for saveButton that validates user's input and updates
     * the selected customer info with query method.
    ...
    /**
     * Method called in initialize sets all form fields with
     * the selected customer's correlated info.
