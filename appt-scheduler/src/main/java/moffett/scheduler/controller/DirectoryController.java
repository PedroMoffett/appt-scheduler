...
import moffett.scheduler.helper.ReportDialog;
...
public class DirectoryController implements Initializable {
    ...
    /**
     * Method populates appointmentsTableView with Appointment objects
     * created from query method, called within initialize.
    ...
    /**
     * MouseEvent takes user to Create Customer form.
    ...
    /**
     * Mouse Event takes user to Edit Appointment form.
     * <p>
     * Validates appointment selected and passes selected item to new form.
    ...
    /**
     * MouseEvent takes user to Create Appointment form.
    ...
    /**
     * MouseEvent takes user to Edit Customer form.
     * <p>
    ...
    /**
     * MouseEvent deletes all selected appointments and then the customer, sending an alert after
    ...
    /**
     * MouseEvent removes selected appointment from database, sending an alert after.
    ...
    /**
     * MouseEvent shows custom ReportDialog while staying in directory.
    ...
    /**
     * MouseEvent asks user to confirm exit and terminates program.
    ...
    /**
     * MouseEvent asks user to confirm logout and sends user to login
