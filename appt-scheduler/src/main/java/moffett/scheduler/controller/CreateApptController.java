...
/**
 * Controller for create-appt-view allows the user to generate appointments.
 */
public class CreateApptController implements Initializable {
    ...
    /**
     * Text field for user to input appointment description.
     */
    @FXML
    private TextField descriptionField;

    /**
     * DatePicker for user to select appointment start date.
     */
    @FXML
    private DatePicker startDateField;

    /**
     * DatePicker for user to select appointment end date.
     */
    @FXML
    private DatePicker endDateField;

    /**
     * Spinner for user to select or input appointment end hour.
     */
    @FXML
    private Spinner<Integer> endHoursSpinner;

    /**
     * Spinner for user to select or input appointment end minute.
     */
    @FXML
    private Spinner<Integer> endMinutesSpinner;

    /**
     * Text field for user to enter appointment location.
     */
    @FXML
    private TextField locationField;

    /**
     * Spinner for user to select appointment start hour.
     */
    @FXML
    ...
    /**
     * Spinner for user to select appointment start minute.
     */
    @FXML
    private Spinner<Integer> startMinutesSpinner;

    /**
     * Text field for user to input appointment title.
     */
    @FXML
    private TextField titleField;

    /**
     * Text field for user to input appointment type.
     */
    @FXML
    ...
    /**
     * ComboBox for0
     * .user to select an appointment UserID.
     */
    @FXML
    private ComboBox<Integer> userIdComboBox;

    /**
     * On Click mouse event that retrieves values from the form, validates them then calls the createAppointment
