...
/**
 * Abstract class for executing queries within the database.
 */
public abstract class Queries {
    ...
    /**
     * Method for updating customers in edit-customer-view screen.
    ...
    /**
     * Method for updating appointment in the edit-appointment-view screen.
    ...
    /**
     * Method for selecting all appointments and storing them in an array list for tableView use.
    ...
    /**
     * Method to get contact names from contacts table in array list.
    ...
    /**
     * Method for selecting contact ID from table using contact name.
     * @param contactName String used to select contact from table.
     * @return returns string containing contact's name.
     * @throws SQLException
     */
    ...
    /**
     * Method for checking if appointment overlaps with an existing appointment for customer.
